...
<a href="add_property.php"  class="green" > Add property </a>
</h4>
								</div><!-- /row -->
								...
								<th class="hidden-480">Type </th>
												...
												<tbody>
													...
													<?php
				$selectproperties=mysql_query("select * from `properties` where `active`='$active' and `agent_id`='$agent_id' and `block`='0'");
...
echo "<b>Rent</b>";
		...
		<a class="blue" target="_blank" href="../property_show.php?id=<?php echo $selectarrayproperties['property_id']; ?>"  >
																	<i class="icon-zoom-in bigger-130"></i>
																</a>

						
<a class="green" href="edit_property.php?id=<?php echo $selectarrayproperties['property_id']; ?>&active=<?php echo $active; ?>" >	
                                                            
																	<i class="icon-pencil bigger-130"></i>
																</a>

<a class="red" href="#modal-table" id="<?php echo $selectarrayproperties['property_id']; ?>del" onclick="deleteproperties(this.id)" data-toggle="modal">
