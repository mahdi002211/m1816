...
$featured=$selectproperty['featured'];
...
<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><b>Description</b></label>
										...
										<div class="col-sm-9">										
<textarea name="description" class="bigdescription">
...
?>
				...
				<td class="center"><img src="propertypic/<?php echo $selectarrayphoto['photo']; ?>" 
				style="width:50px;">
				</td>
...
$insert=mysql_query("insert into `properties` values('$id','$title','$price','$location','$area','$address','$bathrooms','$bedrooms','$short_description','$description','$type','$active','0',' $longitude','$latitude','$featured','$agent_block','$agent_id')");
//////////////////////////////////////////////////////////// features
 $air=$_POST['air'];
 $wifi=$_POST['wifi'];
 $radio=$_POST['radio'];
