...
<div class="modal-body no-padding">
          <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"><b>Contact Name</b> </label>
                                        


										<div class="col-sm-9">

										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"><b>'.$selectcontact['name'].'</b> </label>
	<input type="hidden" name="contactiddel" value="'.$id.'"/>											
										</div>
									</div>
