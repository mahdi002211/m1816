...
<a href="#modal-table" role="button" id="addclient" class="green" data-toggle="modal"> اضافه کردن عکس </a>
</h4>
								</div><!-- /row -->
										...
										<div class="table-responsive">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<?php
				$selectslider=mysql_query("select * from `slider`");
while($selectarrayslider=mysql_fetch_array($selectslider))
													{
...
?>
				...
				<td class="center"><img src="sliderpic/<?php echo $selectarrayslider['slider_pic']; ?>" 
				style="width:50px;">
				</td>
	...
	<a class="blue" href="#modal-table" id="<?php echo $selectarrayslider['slider_id']; ?>view" onclick="showslider(this.id)" data-toggle="modal" >
																	<i class="icon-zoom-in bigger-130"></i>
																</a>															



<a class="red" href="#modal-table" id="<?php echo $selectarrayslider['slider_id']; ?>del" onclick="deleteslider(this.id)" data-toggle="modal">
...
$path = "sliderpic/"; // Upload directory
$count = 0;												
foreach ($_FILES['files']['name'] as $f => $name) {     
	           
	               
	$insert=mysql_query("insert into `slider` values('','$name')");        
...
{
$slideriddel=$_POST['slideriddel'];

$detailslider=mysql_fetch_array(mysql_query("select * from `slider` where `slider_id`='$slideriddel'"));
$slider_pic=$detailslider['slider_pic'];
unlink("sliderpic/".$slider_pic);
$delslider=mysql_query("delete from `slider` where `slider_id`='$slideriddel'");
if($delslider)
{	
echo "<script>
setTimeout(function(){
