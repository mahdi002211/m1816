...
style="width:300px;"><b>Do U want to pend this property: '.$property_title.'</b> </label>
                                        
<input type="hidden" name="propertyidpend" value="'.$id.'"/>
				...
				<button class="btn btn-info" type="submit"   name="submitpend" >
