...
<html lang="en">
  ...
  <script>
  function unblockproperties(id)
  {
  var allid=parseInt(id);
 
  $(document).ready(function(e) {
$.ajax({
url:"unblock_all_properties.php",
type:"GET",
data:"id="+allid,
							...
							<div class="col-xs-12">
								...
								<th class="hidden-480">Type </th>
												...
												<tbody>
													...
													<?php
				$selectproperties=mysql_query("select * from `properties` where  `block`='1' ");
...
echo "<b>Rent</b>";
						...
						<a class="btn btn-app btn-inverse btn-xs" style="width:80px;height:50px;"   href="#modal-table"  id="<?php echo $selectarrayproperties['property_id']; ?>block" onclick="unblockproperties(this.id)" data-toggle="modal" >
												
												<span style="top:5px;position:relative;">Unblock</span>
											</a>
