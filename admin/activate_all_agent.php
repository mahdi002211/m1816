...
style="width:300px;"><b>Do U want to activate this agent: '.$fullname.'</b> </label>
                                        
<input type="hidden" name="agentidactivate" value="'.$id.'"/>
				...
				<button class="btn btn-info" type="submit"   name="submitactivate" >
