...
style="width:300px;"><b>Do U want to reject this property: '.$property_title.'</b> </label>
                                        
<input type="hidden" name="propertyidreject" value="'.$id.'"/>
				...
				<button class="btn btn-info" type="submit"   name="submitreject" >
