...
style="width:300px;"><b>Do U want to Approve this property: '.$property_title.'</b> </label>
                                        
<input type="hidden" name="propertyidapprove" value="'.$id.'"/>
				...
				<button class="btn btn-info" type="submit"   name="submitapprove" >
