...
<html lang="en">
  ...
  <script>
  function pendproperties(id)
  {
  var allid=parseInt(id);
 
  $(document).ready(function(e) {
$.ajax({
url:"pend_all_properties.php",
type:"GET",
data:"id="+allid,
							...
							<div class="col-xs-12">
								...
								<th class="hidden-480">Type </th>
												...
												<tbody>
													...
													<?php
				$selectproperties=mysql_query("select * from `properties` where  `active`='2' ");
...
echo "<b>Rent</b>";
						...
						<a class="btn btn-app btn-inverse btn-xs" style="width:80px;height:50px;"   href="#modal-table"  id="<?php echo $selectarrayproperties['property_id']; ?>pend" onclick="pendproperties(this.id)" data-toggle="modal" >
												
												<span style="top:5px;position:relative;">Pend</span>
											</a>
...
{
$propertyidpend=$_POST['propertyidpend'];
$updateproperty=mysql_query("update `properties` set `active`='0' where `property_id`='$propertyidpend'");
if($updateproperty)
{
echo'<button class="btn btn-success" style="left:400px;bottom:20px;width:250px;">Property pended successfully</button>';	
echo "<script>
setTimeout(function(){
  window.location = 'reject_properties.php';
}, 500);
</script>";													
